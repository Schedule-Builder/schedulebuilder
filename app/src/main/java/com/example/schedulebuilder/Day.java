...
public class Day implements Serializable { // effectively a fancy priority queue
  ...
  public Day(ArrayList<Event> event){
    byPriority = event;
    byTime = event;
  }// this arrayList is sorted based upon the priority level of each event
